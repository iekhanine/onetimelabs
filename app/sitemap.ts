...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/products/roffle`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/products/tasks`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/custom-development`, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/toolkits`, changeFrequency: "weekly", priority: 0.6 },
