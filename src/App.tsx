...
export default function App() {
  return <div className="app-shell"><StoreHeader /><Routes>
    ...
    <Route path="/business" element={<InvestorPage />} />
    <Route path="/business/plan" element={<BusinessPlanPage />} />
    <Route path="/investors" element={<Navigate to="/business" replace />} />
    <Route path="/investors/plan" element={<Navigate to="/business/plan" replace />} />
